...
const LONG_TERM_MEMORIES = [
  ...
  {
    title: '문파 상세: 화산파',
    content: '본거지 섬서. 상징색은 보라색. 오래 전부터 종남파와 경쟁하였다. 보검 '화종요연'을 보유 중이다. 매화나무에서 나는 매실로 술을 담가서 판매하는 사업을 하고 있다. 곤륜칠웅 중 하나였던 신선 길화선이 문파의 시조이며, 종남파의 시조인 신선 채용아와 반목한 것을 계기로 사이가 틀어졌다고 한다. 상대의 기운을 흡수하는 무공을 주로 사용한다.',
  },
  {
    title: '문파 상세: 종남파',
    content: '본거지 섬서. 상징색은 파란색. 오래 전부터 화산파와 경쟁하였다. 보검 '산남필인'을 보유 중이다. 쪽풀에서 나오는 푸른 염료로 옷을 염색해 판매하는 사업을 하고 있다. 곤륜칠웅 중 하나였던 신선 채용아가 문파의 시조이며, 화산파의 시조인 신선 길화선과 반목한 것을 계기로 사이가 틀어졌다고 한다. 상대의 기운을 회피하는 무공을 주로 사용한다.',
  },
  {
    title: '문파 상세: 소림사',
  ...
  {
    title: '문파 상세: 점창파',
    content: '본거지 사천. 상징색은 검은색과 보라색. 멸문당한 청성파의 잔당들과 운남의 무림인들이 융합하여 탄생한 문파. 사흉을 비롯한 마수들을 봉인하기 위한 '점창봉인관'이 유명하다. 하지만 청성파 세력들이 주가 되었기에 마공과 사술에 굉장히 호의적이고 활발하게 연구한다. 무공과 다양한 신공들이 결합한 형태의 고유한 기술을 사용하며, 강해질 수 있다면 수단과 방법을 가리지 않기로 유명하다.',
  },
  {
    title: '문파 상세: 공동파',
  ...
  {
    title: '문파 상세: 개방',
    content: '본거지 하북. 상징색은 녹색. 곤륜칠웅 아사거는 신선이 되는 것을 포기하고 인간으로 남았다. 그는 평생 비단옷을 입지 않았다. 그는 자신의 삶에서 가장 큰 인연이었던 두 사람의 이름을 따서 '개방'을 만들었다. 아사거는 고아로 태어나 거지로 살다 납치되어 노비가 되었으나 탈출 후 팽리방의 제자가 되었다. 그는 거지들이 스스로를 보호하고 도울 수 있게 하도록 개방을 만들었다. 시간이 지나며 어떠한 교육도 받지 못하는 개방 거지들의 의식 수준은 추락했지만, 그의 가르침은 잊지 않은 채 여전히 개방을 이끌고 있다.',
  },
    },
  {
    title: '세력 상세: 녹림',
