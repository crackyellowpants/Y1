...
const LONG_TERM_MEMORIES = [
  ...
  {
    title: '설화: 요계 5',
    content: '적요계의 주작도 심장이 뽑혀 죽어 이제 요계에는 청요계의 왕 청룡 진후와 백요계의 왕 백호 인훤만이 남았다. 어질고 온화한 성품의 두 왕은 인간들이 요계를 희롱하는 모습을 보고 인간계에 침공하기보다는 그 뛰어남을 배우고자 했다. 이에 두 왕을 필두로 한 12명의 요괴들이 천축의 기원사에 당도하여 가르침을 구했다. 훗날 이들은 요살이라 불리며 많은 이들의 존경을 받게 된다.',
  },
  {
    title: '배경: 육문 1',
  ...
  },
  {
    title: '무공: 무당파',
    content: `# 무당파 무공
- 정석적인 검법을 중심으로 구성되어있다.
- 원론적인 내용이 많아 이해가 어려우나 응용 가능성이 매우 뛰어나다.
- 상대의 공격을 흘리는 데 특화되어 있으며, 정확한 반격을 통해 효율적인 전투를 구사한다.
- 무당파 무공서적:
 - 팽리방 기초무림수련서
 - 팽리방 심화무림수련서
 - 하북팽가 검법해설
 ...
 - 곤륜파 청해검법서`,
  },
  {
    ...
    content: `# 화산파 무공
- 정석적인 검법을 중심으로 구성되어있다.
- 애매한 표현이 많아 이해가 어려우나 실전 효용성은 매우 뛰어나다.
- 주도권을 잡고 전투를 이끌어가는 법에 대해 자세히 다루고 있다.
- 최상위 무공으로 화산의 매실주를 마시고 행하는 검법 취화선(取華仙)이 있다.
- 무당파 무공서적:
 - 길화선 기초무림수련서
 - 길화선 심화무림수련서
 - 섬서여가 검법해설`,
  },
  {
    ...
    content: `# 종남파 무공
- 정석적인 검법을 중심으로 구성되어있다.
- 어려운 단어가 많아 이해가 어려우나 내용 자체는 단순하다.
- 주변 지형지물을 이용한 전투에 특화되어 있으며, 상대를 심리적으로 압박하는 방식에 대해 깊게 다룬다.
- 섬서의 검술 중에 가장 배우기 쉽지만 통달하는 것은 가장 어렵다.
- 무당파 무공서적:
 - 채용아 기초무림수련서
 - 채용아 심화무림수련서
 - 섬서양가 검법해설
 - 섬서양가 검법해설별편`,
  },
  {
    title: '무공: 소림사',
    content: `# 소림사 무공
- 무술과 봉술로 구성되어있으며 문파가 오래된 만큼 내용이 방대하다.
- 무술의 경우 상대와 몸을 붙이고 싸우는 지투법(地鬪法)과 거리를 벌리고 싸우는 입투법(立鬪法)으로 나눠져 있다.
- 봉술의 경우 대부분 아미파에 기증하여 기록이 적다.
- 소림사 무공서적:
 - 아태상야 입투교본
 - 귀주막가 지투교본
 - 소림 기본무술서
 - 소림 기초봉법해설`,
  },
  {
    title: '무공: 아미파',
    content: `# 아미파 무공
- 봉술과 봉인술로 구성되어 있으며 대부분 두 기술을 연계하여 사용한다.
- 봉술의 경우 순수한 무공의 형태로 전해지지만, 봉인술은 요술과 연계해야 효과적이다.
- 봉술으로 상대와 거리를 벌린 후 봉인술으로 원거리에서 압박하는 방식을 선호한다.
- 아미파 무공서적:
 - 요살 진후 요술입문서
 - 소림 봉법전집
 - 청해 서문세가 봉인해설
 - 아미파 봉인응용총서`,
  },
  {
    title: '무공: 점창파',
    content: `# 점창파 무공
- 창술을 주로 사용하지만 여러가지 사술과 마공이 융합하면서 기이한 형태를 하고 있다.
- 점혈을 찔러 상대를 무력화하는 방식을 주로 사용하며, 원거리에서는 간단한 봉인술을 사용한다.
- 매복과 급습에 특화된 전략을 사용한다.
- 점창파 무공서적:
 - 주성아 영약방문
 - 사천당가 극독도감
 - 당한 사술서
 ...
 - 아미파 기초봉인해설`,
  },
  {
    title: '무공: 공동파',
    content: `# 공동파 무공
- 무공과 요술을 결합해서 사용하며, 요술에 뛰어난 이해를 가지고 있다.
- 개방적인 문화로 인해 다양한 종류의 응용 검법을 구사한다.
- 개활지에서 효과적인 범위 공격을 주로 사용하며 좁은 지역에서는 약점을 보인다.
- 공동파 무공서적:
 - 감숙 공손세가 검법해설
 - 요살 인훤 요술심화해설
 - 천축 요검해설
 ...
 - 곤륜파 청해검법서`,
  },
  {
    title: '무공: 해남파',
    content: `# 해남파 무공
- 남쪽 지방 해적들의 변칙적인 전투 방식과 무공이 융합하여 내용은 중구난방이지만 엄청난 변수를 창출할 수 있다.
- 수상 전투 시에 효과적인 전술의 이해도가 높고, 파도의 움직임을 본뜬 검술을 사용한다.
- 굉장히 실용적인 측면이 강하고 살상무공의 정수를 보여주는 내용이 많다.
- 해남파 무공서적:
 - 광동어가 검법해설
 - 어공리 검법심화해설서
 - 해남 수상전기본서
 ...
 - 민세강 기본검술교본`,
  },
  {
    title: '무공: 형산파',
    content: `# 형산파 무공
- 치고 빠지는 속도전과 비겁하고 잔혹한 녹림의 성향이 짙게 묻어나는 무공이다.
- 이기기 위해서는 어떠한 방식도 존중하는 형산 고유의 문화와 융합하였으며, 상대방을 비난하여 심리적 우위를 가지는 내용도 존재한다.
- 소실된 부분이 많기 때문에 내용을 완전히 알기는 어렵지만 그로 인해 다양한 파생형이 생겼다.
- 형산파 무공서적:
 - 호남서가 검술심화
 - 강소 모용세가 검법서
 - 녹림천하제일검법서
 ...
 - 편아현 기본검술교본`,
  },
  {
    title: '무공: 개방',
    content: `# 개방 무공
- 글을 읽지 못하는 사람이 대다수이기 때문에 내용이 온전히 전해 내려오는 법이 거의 없으며, 대부분 구전되어서 그마저도 변질된 부분이 많다.
- 무공서적의 경우 책에 찢어진 부분이나 낙서가 많아 읽기가 어렵다.
- 하지만 시조 아사거가 당대 최강의 검객이었기에 내용을 알면 굉장히 파괴적이다.
- 개방 무공서적:
 - 아사거 검술서
 - 홍배의 주먹 쓰는 법 모음집
 - 해룡권법서`,
...
- 대표적인 순향식:
 ...
 - 타건지양(唾乾之陽): 태양의 기운으로 신체를 소독한다`,
  },
  {
    title: '사술: 역화술',
    content: `# 역화술
- 감염을 일으키는 사술을 역화술이라 한다.
- 대표적인 역화술:
 - 왜벌화(歪罰花): 피부가 썩는 역병을 뿌린다
 - 골온(滑瘟): 급격히 퍼지는 역병을 뿌린다
 - 백소(白燒): 작열하는 고통의 역병을 뿌린다
 - 식화려(食和旅): 주변을 마구잡이로 공격하게 하는 광기의 역병을 뿌린다`,
  },
  {
    title: '사술: 독화술',
    content: `# 독화술
- 중독을 일으키는 사술을 독화술이라 한다.
- 대표적인 독화술:
 - 할골(割骨): 뼈에 스미는 독을 주입한다
 - 탈어고진(奪語苦塵): 매캐한 독성 구름을 뿜어낸다
 - 암패가인(暗沛加刃): 출혈을 일으키는 독을 생성한다
 - 곡화벽시曲禍碧屍: 신체가 뒤틀리게 만드는 독을 뿌린다`,
  },
  {
    title: '사술: 기화술',
    content: `# 기화술
- 기운을 타락시키는 사술을 기화술이라 한다.
- 대표적인 기화술:
 - 불류토염(不流吐炎): 씻어내기 힘든 역한 기운을 뿌린다
 - 울화융(鬱火融): 마음에 고통을 주는 기운을 던진다
 - 우병하몰(雨病河歿): 주변 환경을 황폐화시킨다
 - 파은마운(波銀魔雲): 기운의 흐름을 어지럽힌다`,
  },
  {
    title: '마공: 혼마공',
    content: `# 혼마공
- 상대의 기운을 어지럽히는 마공을 혼마공이라 한다.
- 대표적인 혼마공:
 - 굴압(屈壓): 상대를 끌어당겨 제압한다
 - 낙천궁(落天穹): 상대의 모든 천문 무공을 무효화한다
 - 암비군(暗匕群): 상대의 기운을 찢어발긴다
 - 피외골(皮外骨): 상대의 신체를 뒤틀어버린다`,
  },
  {
    title: '마공: 탐마공',
    content: `# 탐마공
- 자신의 기운을 폭주시키는 마공을 탐마공이라 한다.
- 대표적인 탐마공:
 - 올력(兀力): 한계를 뛰어넘는 기운을 발산한다
 - 요매(療魅): 미래의 수명을 바쳐 순간적으로 회복한다
 - 갈붕(渴崩): 정신을 놓고 파괴를 갈망하는 마귀로 변한다
 - 이뇌야(理腦也): 상상을 현실로 실현한다`,
  },
  {
    title: '마공: 합마공',
    content: `# 합마공
- 수문에 천문을 더한 마공을 뜻하며 굉장히 위험한 부작용이 잇따른다.
- 대표적인 합마공:
 - 역천(易天): 기억만을 보유한 채 과거로 돌아간다
 - 신차(神遮): 상대의 천문 무공을 영원히 봉인한다
 - 몽국(夢國): 상대를 다른 세계로 추방한다
 - 벽빙(碧氷): 자신의 수문 마공을 영원히 봉인하고 잠시동안 신선과 같은 힘을 얻는다`,
  },
  {
    title: '요술: 현요술',
    content: `# 현요술
- 이해하기 어려운 현상을 발생시키는 요술을 현요술이라 한다.
- 대표적인 현요술:
 - 오람(烏濫): 까마귀 떼를 소환하여 몸을 숨겨 순간이동한다
 - 마이(魔耳): 상대의 마음을 읽는 독심술을 사용한다
 - 변대타(辯對咤): 상대를 꾸짖어 진실만을 말하게 한다
 - 자량(資量): 어려운 계산을 단숨에 해낸다`,
  },
  {
    title: '요술: 흉요술',
    content: `# 흉요술
- 피해를 입히려는 목적을 가진 요술을 흉요술이라 한다.
- 대표적인 흉요술:
 - 화련두(火鍊頭): 불덩어리를 날린다
 - 뇌량수(雷梁輸): 거대한 벼락 기둥을 내리꽂는다
 - 괘냉우(卦冷雨): 위협적인 우박 폭풍을 소환한다
 - 망지토(亡地土): 땅을 갈라 낭떠러지를 만든다`,
  },
  {
    title: '요술: 길요술',
    content: `# 길요술
- 좋은 상황을 만들어내는 요술을 길요술이라 한다.
- 대표적인 길요술:
 - 득패(得牌): 일시적으로 운이 좋아진다
 - 사매(思昧): 다음날 일어날 일을 어렴풋이 알게 된다
 - 노인만(路引彎): 복잡한 상황을 꿰뚫어본다
 - 원구인(元求人): 자신의 목숨을 바쳐 대상의 불행을 흡수한다`,
  },
  {
    title: '신공: 천마신공',
    content: `# 천마신공
- 신선의 힘을 인간의 육신에 집어넣는 위험하고 강력한 신공.
- 무조건 대상이 있어야만 사용할 수 있으며, 스스로에게는 사용할 수 없다.
- 사용 시, 사용자는 반드시 사망하며, 대상자는 천마가 된다.
- 천마의 그릇이 되지 못한 대상에게 사용하면 대상도 사망한다.
- 천마의 그릇이 되려면 높은 수준의 천문과 수문을 보유해야 한다.
- 천마가 되면 감정이 결여되고, 기존의 질서를 뒤엎고 새로운 세상을 만드는 것을 목표로 하게끔 인격이 변화한다.`,
  },
  {
    title: '신공: 환륜신공',
    content: `# 환륜신공
- 사용자를 포함한 5명의 제물이 필요하다.
- 사용 시, 사용자는 즉사, 세 명은 봉인, 남은 한 명은 저주에 걸린다.
- 사용자가 열 갑자(600년) 동안 환생하며 6개의 다른 세상에서 100년을 살아가야 한다.
- 저주에 걸린 사람은 30년에 한 번씩 신체가 회귀하여 서서히 기억을 잃고 다시 살아가는 삶을 반복해야 한다.
- 봉인된 세 사람은 사용자가 600년을 채우고 원래 세상에서 원래 모습으로 돌아오면 봉인이 풀린다.
- 이후 사용자와 저주에 걸린 자는 만나면 전생의 기억을 되찾는다.`,
  },
  {
    title: '신공: 명적신공',
    content: `# 명적신공
- 천문과 수문을 매우 높은 수준으로 보유할 경우 발현된다.
- 발현자는 굉장히 난폭하면서 지배적인 성향을 보인다.
- 사용자는 대상을 노예화하여 마음대로 다룰 수 있다.
- 파괴적인 행위를 할 수록 위력이 강해진다.
- 강박적인 행위를 할 수록 위력이 강해진다.
- 정신적으로 혼란을 느낄수록 위력이 강해진다.
- 알려진 명적신공 보유자: 묵화린.`,
  },
];
