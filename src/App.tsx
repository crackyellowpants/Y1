...
const MAP_POINTS = [
  { name: '감숙', x: 704, y: 416, info: '감숙(甘肅)은 서역으로 통하는 실크로드의 관문으로, 공동파가 자리잡고 있습니다.' },
  { name: '강소', x: 956, y: 443, info: '강소(江蘇)는 강남의 풍요로운 지역으로, 남궁세가 등 유력 세가들이 자리잡고 있습니다.' },
  { name: '광동', x: 862, y: 639, info: '광동(廣東)은 남방 무술의 발원지이자 해남파로 향하는 길목입니다.' },
  { name: '내몽고', x: 907, y: 216, info: '내몽고(內蒙古)는 끝없는 초원이 펼쳐진 곳으로, 새외 무림의 강자들이 활동하는 영역입니다.' },
  { name: '북경', x: 906, y: 304, info: '북경(北京)은 황실이 있는 수도로, 금의위와 동창 등 관의 무력이 집중된 곳입니다.' },
  { name: '사천', x: 674, y: 507, info: '사천(四川)은 촉산의 험한 산세 속에 사천당가와 아미파가 굳건히 자리하고 있습니다.' },
  { name: '상해', x: 997, y: 493, info: '상해(上海)는 바다와 맞닿은 항구 도시로, 다양한 세력이 교차하는 곳입니다.' },
  { name: '섬서', x: 773, y: 436, info: '섬서(陝西)는 화산파와 종남파가 위치한 무림의 핵심 지역 중 하나입니다.' },
  { name: '요녕', x: 1019, y: 278, info: '요녕(遼寧)은 관외로 통하는 길목으로, 장백산맥의 정기를 받은 고수들이 은거하고 있습니다.' },
  { name: '장강', x: 789, y: 498, info: '장강(長江)은 남북을 가르는 거대한 강으로, 장강수로십팔채 등 수로 무림의 중심입니다.' },
  { name: '중경', x: 743, y: 527, info: '중경(重慶)은 사천으로 들어가는 관문이자 물류의 중심지입니다.' },
  { name: '청해', x: 573, y: 399, info: '청해(靑海)는 곤륜산맥이 뻗어있는 험준한 지역으로, 곤륜파의 본산이 위치해 있습니다.' },
  { name: '하남', x: 854, y: 437, info: '하남(河南)은 중원의 중심이자 천하무공의 태산북두인 소림사가 위치한 성지입니다.' },
  { name: '하북', x: 890, y: 344, info: '하북(河北)은 황실의 중심지인 북경을 둘러싸고 있으며, 수많은 정파 무림의 근거지입니다.' },
  { name: '호남', x: 829, y: 557, info: '호남(湖南)은 동정호가 위치한 곳으로, 개방의 총타와 무림맹의 주요 거점이 있습니다.' },
  { name: '황하', x: 771, y: 289, info: '황하(黃河)는 중원의 젖줄이자 수많은 수로채와 흑도 무리들이 암약하는 곳입니다.' },
];
